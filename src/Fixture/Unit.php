      ...
      [
        ...
        'connections' => [
          ...
          [
            ...
            'name_en' => 'phone or email en 2',
            'name_sv' => 'phone or email sv 2',
          ...
          [
            ...
            'name_fi' => 'other info fi 1',
            'name_en' => 'other info en 1',
            'name_sv' => 'other info sv 1',
          ],
          [
            'unit_id' => 1,
            'section_type' => 'OTHER_INFO',
            'name_fi' => 'other info fi 2',
            'name_en' => 'other info en 2',
            'name_sv' => 'other info sv 2',
          ],
          [
            'unit_id' => 1,
            'section_type' => 'TOPICAL',
            'name_fi' => 'topical fi 1',
            'name_en' => 'topical en 1',
            'name_sv' => 'topical sv 1',
            'www_fi' => 'https://localhost/fi',
            'www_en' => 'https://localhost/en',
            'www_sv' => 'https://localhost/sv',
          ],
          [
            'unit_id' => 1,
            'section_type' => 'TOPICAL',
            'name_fi' => 'topical fi 2',
            'name_en' => 'topical en 2',
            'name_sv' => 'topical sv 2',
            'www_fi' => 'https://localhost/fi',
            'www_en' => 'https://localhost/en',
            'www_sv' => 'https://localhost/sv',
          ],
